...
a = Analysis(
    ...
    datas=st_datas + datas_meta + [
        ...
        ('../shared/question_prediction.py', '.'),
        ('../shared/industry_engine.py', '.'),
        ('../shared/persona_engine.py', '.'),
        ('../shared/mock_interview_engine.py', '.'),
        ('../shared/answer_assist.py', '.'),
    ...
    hiddenimports=st_hiddenimports + [
        ...
        'interview_engine', 'favorites',
        'pr_generation', 'question_prediction', 'personality_assessment',
        'company_matrix', 'summary_generation',
        'industry_engine', 'persona_engine', 'mock_interview_engine', 'answer_assist',
